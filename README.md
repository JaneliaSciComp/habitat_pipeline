...
| `field_significance(..., null_method='circular_shift'|'position_shuffle')` | Shuffle null. `compute_social_place_fields` defaults to `'auto'`: `position_shuffle` under a self-position stratum, `circular_shift` otherwise. |
